...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>AuraPro - AI Aura Scanner 🔮 | IIT Wars Live</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
        <meta name="description" content="AI scans anyone's aura and reveals their true power level. Are they LEGENDARY or just an NPC? Plus live IIT Wars college battles!" />
      ...
      <div style={{ 
        ...
        {!aura ? (
          <div>
            ...
            {/* 🔥🔥🔥 ENHANCED IIT WARS LIVE SECTION 🔥🔥🔥 */}
            <div style={{
              ...
              padding: '28px 24px',
              marginBottom: '30px',
              boxShadow: '0 20px 60px rgba(0, 255, 255, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.1)',
              position: 'relative',
              overflow: 'hidden'
            }}>
              ...
              <div style={{
                position: 'absolute',
                inset: '-40px',
                background: 'radial-gradient(circle at 50% 50%, rgba(0, 255, 255, 0.2) 0%, transparent 60%)',
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    7-Day College Battle Championship
                  </p>
                  <div style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    ...
                    ⚔️ {campusWarsBattles.toLocaleString()} battles today
                  </div>
                </div>
                ...
                <Link href="/campus-wars">
                  <div style={{
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.target.style.boxShadow = '0 15px 40px rgba(0, 255, 255, 0.7)';
                    }}
                    onMouseLeave={(e) => {
        ...
        <footer style={{ textAlign: 'center', padding: '40px 0 20px', marginTop: '40px' }}>
          <p style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.3)' }}>
            AuraPro © 2025 • AI Aura Scanner & IIT Wars
          </p>
        </footer>
      </div>
